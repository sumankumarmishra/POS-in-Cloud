...
namespace POSWebApplication.Models
{
    ...
    {
        [Key] public int ApId { get; set; }
        [DisplayName("Acc-Code")][StringLength(9)] public string ApAcCde { get; set; } = string.Empty;
        [StringLength(100)] public string ApNme { get; set; } = string.Empty;
